$(document).ready(function () {
    ...
    function get_PostTest() {
        ...
        $.ajax({
            ...
            async: false,
            url: 'PM_dashboard_data.asmx/Get_PM_PostTest',
            cache: false,
											...
											[
												{
												    ...
												    series: [
															...
															{ dataField: 'PostTest', displayText: 'PostTest', lineColor: '#cccccc', fillColor: '#e3e3e3' }
													]
												},
                                                {
                                                    type: 'line',
                                                    valueAxis:
                                                        {
                                                            minValue: 0,
                                                            unitInterval: .1,
                                                            description: 'Post Test Rate',
                                                            postion: "left",
                                                        },
                                                    series: [
                                                        { dataField: 'PostTestPer', displayText: 'Post Test %' }
                                                    ]
                                                }
											]
